...
class VehicleCompany {
    ...
    // Method to add a car model with its price ranges (base and premium variants)
    ...
    public void displayCars() {
        System.out.println(WHITE + "Company: " + companyName + RESET);
        System.out.println(WHITE + "+----------------------+------------------+------------------+" + RESET);
        System.out.println(WHITE + "| Model Name           | Base Variant     | Premium Variant  |" + RESET);
        System.out.println(WHITE + "|----------------------+------------------+------------------|" + RESET);
        for (Map.Entry<String, String[]> entry : cars.entrySet()) {
            System.out.printf(WHITE + "| %-20s | %-16s | %-16s |" + RESET + "%n",
    ...
    public void displayCarsByAmount(double amount) {
        ...
        if (!hasCars) {
            System.out.println(WHITE + "| No cars found in this price range.                      |" + RESET);
        }
        System.out.println(WHITE + "+----------------------+------------------+------------------+" + RESET);
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        String white = "\u001B[97m"; // Bright White

        Scanner scanner = new Scanner(System.in);
        Map<String, VehicleCompany> companies = new HashMap<>();

        // Adding companies and their cars
        VehicleCompany suzuki = new VehicleCompany("Suzuki");
        suzuki.addCarModel("Alto K10", "4.09 Lakh", "6.05 Lakh");
        suzuki.addCarModel("S-Presso", "4.26 Lakh", "6.12 Lakh");
        suzuki.addCarModel("Baleno", "6.49 Lakh", "9.71 Lakh");
        ...
        hyundai.addCarModel("Creta", "11.00 Lakh", "20.00 Lakh");
        ...
        System.out.print(white + "Enter the car brand you want : " + reset);
        ...
        if (brand.equalsIgnoreCase("all")) {
            ...
            System.out.print(white + "Enter the amount you want car in that amount: " + reset);
            ...
            System.out.println(white + "Sorry, we don't have information on this brand." + reset);
        }

        // Formal Thank You Message
        System.out.println();
        System.out.println(white + "============================================================" + reset);
        System.out.println(white + "   Thank you for visiting our Vehicle Showroom!" + reset);
        System.out.println(white + "============================================================" + reset);
